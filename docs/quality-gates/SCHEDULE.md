...
|------|---------|--------|-----------------|
| QG-DALI-persistence | after dali merge | ⏳ | не проверялось |
| QG-DALI-ygg-write | after parse run | ✅ GREEN | 15.04.2026 — 98.8% / 143K atoms |
| QG-CHUR-resilience | after chur merge | ⏳ | не проверялось |
| QG-SECURITY-demo | 24h before demo | ⏳ | не проверялось |
| QG-HEIMDALL-backend-validation | after heimdall merge | ⏳ | не проверялось |
| QG-HEIMDALL-frontend-ws | before demo | ⏳ | не проверялось |
| QG-VERDANDI-prefs-sync | after stores/ merge | ⏳ | не проверялось |
| QG-HOUND-listener-chain | after hound merge | ⏳ | ждёт H3.8 |
| **QG-PERFORMANCE-weekly** | **каждый понедельник** | ⏳ | baseline 15.04 |
| **QG-ARCH-daily** | **ежедневно** | ⏳ | не запускался |

**Demo-ready: ⏳ — обновить после прогона P0**
